          ...
          <div class="space-y-4">
            <div class="space-y-2">
              ...
              <p class="text-gray-500 dark:text-gray-400 md:text-xl">
                Showcasing my expertise in building modern, responsive web applications.
              </p>
            </div>
            <div dir="ltr" data-orientation="horizontal">
              <div
              ...
              >
                <button
                  ...
                  role="tab"
                  aria-selected="true"
                  aria-controls="radix-:r1i:-content-frontend"
                  data-state="active"
                  id="radix-:r1i:-trigger-frontend"
                  class="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow"
                  tabindex="-1"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                ...
                <button
                  ...
                  role="tab"
                  aria-selected="false"
                  aria-controls="radix-:r1i:-content-backend"
                  data-state="inactive"
                  id="radix-:r1i:-trigger-backend"
                  class="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow"
                  tabindex="-1"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                ...
                <button
                  ...
                  role="tab"
                  aria-selected="false"
                  aria-controls="radix-:r1i:-content-fullstack"
                  data-state="inactive"
                  id="radix-:r1i:-trigger-fullstack"
                  class="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow"
                  tabindex="-1"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
              ...
              <div
                ...
                data-orientation="horizontal"
                role="tabpanel"
                aria-labelledby="radix-:r1i:-trigger-frontend"
                id="radix-:r1i:-content-frontend"
                tabindex="0"
                class="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                style=""
              >
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-1">
                  <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
                    <div class="flex flex-col space-y-1.5 p-6">
                      ...
                      <p class="text-sm text-muted-foreground">
                        Building a responsive and feature-rich e-commerce website using React and Tailwind CSS.
                      </p>
                    </div>
                    <div class="p-6">
                      <div class="flex items-center justify-center h-full">
                  ...
                  <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
                    <div class="flex flex-col space-y-1.5 p-6">
                      ...
                      <p class="text-sm text-muted-foreground">
                        Developing a modern and conversion-focused landing page for a SaaS product using Next.js.
                      </p>
                    </div>
                    <div class="p-6">
                      <div class="flex items-center justify-center h-full">
                        ...
                        <button class="justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary underline-offset-4 hover:underline h-10 px-4 py-2 flex items-center gap-2"></button>
                      </div>
                    </div>
                  </div>
                </div>
